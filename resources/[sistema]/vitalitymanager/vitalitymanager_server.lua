-- loosely based on MTA's https://code.google.com/p/mtasa-resources/source/browse/trunk/%5Bmanagers%5D/vitalitymanager/vitalitymanager_main.lua
...
AddEventHandler('vitalitymanager:roundEnded', function()
