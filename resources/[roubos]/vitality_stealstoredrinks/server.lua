...
-----------------------------------------------------------------------------------------------------------------------------------------
func = {}
Tunnel.bindInterface("vitality_stealstoredrinks",func)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
...
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhookroubodp = "https://discord.com/api/webhooks/784774172362276867/kSBWPRP-mC_zsXzjip1RpgBcRXkuticWJ_zc4dVhXp1ZnbwJJVCIhLk-4aeWZb04smGe"
...
-----------------------------------------------------------------------------------------------------------------------------------------
local armalist = {
	[1] = { ['index'] = "energetico", ['qtd'] = 5, ['name'] = "Energetico" }
}
...
function func.checkRobbery(id,x,y,z)
	...
	if user_id then
		...
		if #policia >= 3 and not vRPclient.changingClothes(source) then
			if timers == 0 or not timers then
				timers = 500
				TriggerClientEvent('iniciandolojabebidas',source,id,x,y,z)
					...
					for l,w in pairs(policia) do
						...
						if player then
							async(function()
								...
								TriggerClientEvent('chatMessage',player,"190",{64,64,255},"O roubo começou na ^1Loja de Bebidas^0, dirija-se até o local e intercepte o assaltante.")
