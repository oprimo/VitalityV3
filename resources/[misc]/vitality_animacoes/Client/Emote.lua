...
RegisterCommand('a', function(source, args, raw) EmoteCommandStart(source, args, raw) end)
...
function EmoteChatMessage(args)
  if args == display then
    TriggerEvent("chatMessage", "^5VLT^1", {0,0,0}, string.format(""))
  else
    TriggerEvent("chatMessage", "^4VLT^1", {0,0,0}, string.format(""..args..""))
  end
end
...
function EmoteCommandStart(source, args, raw)
    ...
    elseif DP.PropEmotes[name] ~= nil then
      ...
      EmoteChatMessage("Animação não encontrada.")
    end
  end
end
