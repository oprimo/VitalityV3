RegisterNetEvent("vitality-personagem:normalSpawn")
RegisterNetEvent("vitality-personagem:characterCreate")
...
AddEventHandler("vitality-personagem:characterCreate",function()
	doStatus = 1
...
AddEventHandler("vitality-personagem:normalSpawn",function(firstspawn)
	if firstspawn then
...
RegisterNUICallback('cDoneSave',function(data,cb)
	...
	if GetEntityModel(PlayerPedId()) == GetHashKey("mp_m_freemode_01") then
		...
		SetPedComponentVariation(PlayerPedId(),4,87,1,2)
		SetPedComponentVariation(PlayerPedId(),5,43,0,2)
		SetPedComponentVariation(PlayerPedId(),6,76,3,2)
		SetPedComponentVariation(PlayerPedId(),7,0,0,2)
		SetPedComponentVariation(PlayerPedId(),8,15,0,2)
		SetPedComponentVariation(PlayerPedId(),9,0,0,2)
		SetPedComponentVariation(PlayerPedId(),10,-1,0,2)
		SetPedComponentVariation(PlayerPedId(),11,9,0,2)
	...
	SetEntityCoordsNoOffset(PlayerPedId(),240.38,-1380.09,33.75,true,true,true)
	...
	TriggerServerEvent("vitality-personagem:finishedCharacter",characterNome,characterSobrenome,characterAge,currentCharacterMode)
end)
