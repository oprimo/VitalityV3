...
vRPNserver = Tunnel.getInterface("vitality_identidade")
-----------------------------------------------------------------------------------------------------------------------------------------
-- IDENTIDADE
-----------------------------------------------------------------------------------------------------------------------------------------
local css = [[
	...
	while true do
		...
		if IsControlJustPressed(0,344) and GetEntityHealth(PlayerPedId()) > 101 then
			if identity then
				...
				vRP._setDiv("registro",css,"<b>Passaporte:</b> "..user_id.."<br><b>Nome:</b> "..nome.." "..sobrenome.."<br><b>Idade:</b> "..idade.."<br><b>Identidade:</b> "..identidade..bjob..bvip.."<br><b>Carteira:</b> "..carteira.."<br><b>Banco:</b> "..banco..bmultas)
				identity = true
			end
		end
	end
