...
local itemlist = {
	...
	["reagente"] = { index = "reagente", nome = "Reagente", type = "usar" },
	["kiteletronico"] = { index = "kiteletronico", nome = "Kit Eletronico", type = "usar" },
	["pano"] = { index = "pano", nome = "Pano", type = "usar" },
	["plastico"] = { index = "plastico", nome = "Plastico", type = "usar" },
	["distintivo"] = { index = "distintivo", nome = "Distintivo", type = "usar" },
	["compattach"] = { index = "compattach", nome = "Comp Attachs", type = "usar" },
	...
	["pendrive"] = { index = "pendrive", nome = "Pen Drive", type = "usar" },
	...
	["cocamisturada"] = { index = "cocamisturada", nome = "Coca Misturada", type = "usar" },
	---------------------------------------------------------------------------------------------------
	--[ Organização Criminosa de Drogas 03 ]-----------------------------------------------------------
	---------------------------------------------------------------------------------------------------
	["maconha"] = { index = "maconha", nome = "Maconha", type = "usar" },
	--[ Sub produto ]----------------------------------------------------------------------------------
	["maconhamacerada"] = { index = "maconhamacerada", nome = "Maconha Cerada", type = "usar" },
	...
	["keysinvasao"] = { index = "keysinvasao", nome = "Cartão", type = "usar" },
	--[ Sub produto ]----------------------------------------------------------------------------------
	["indica"] = { index = "indica", nome = "Canabis Indica", type = "usar" },
	["sativa"] = { index = "sativa", nome = "Canabis Sativa", type = "usar" },

	["lsd"] = { index = "lsd", nome = "Lsd", type = "usar" },
	["acidolisergico"] = { index = "acidolisergico", nome = "Ácido lisérgico", type = "usar" },
	["complsd"] = { index = "complsd", nome = "Comp. LSD", type = "usar" },
	---------------------------------------------------------------------------------------------------
	--[ Organização Criminosa de Drogas 02 ]-----------------------------------------------------------
	---------------------------------------------------------------------------------------------------
	...
	["graosimpuros"] = { index = "graosimpuros", nome = "Grãos Impuros", type = "usar" },
	["garrafavazia"] = { index = "garrafavazia", nome = "Garrafa Vazia", type = "usar" },
	["isca"] = { index = "isca", nome = "Isca", type = "usar" },
	["caixa"] = { index = "caixa", nome = "Caixa", type = "usar" },
	["caixadeuva"] = { index = "caixadeuva", nome = "Caixa Com Uva", type = "usar" },
	--------------------------------------------------------------------------------------------------
	--[Pesca]---------------------------------------------------------------------------------------
	----------------------------------------------------------------------------------------------
	["tubaraomartelo"] = { index = "tubaraomartelo", nome = "Tubarão Martelo", type = "usar" },
	...
	["wbody|WEAPON_SNSPISTOL_MK2"] = { index = "amt800", nome = "Pistol Amt800", type = "equipar" },
	["wammo|WEAPON_SNSPISTOL_MK2"] = { index = "m-amt800", nome = "M.Amt800", type = "recarregar" },
	---------------------------------------------------------------------------------------------------
	--[ SMG ]------------------------------------------------------------------------------------------
	---------------------------------------------------------------------------------------------------
	["wbody|WEAPON_SMG"] = { index = "mp5", nome = "MP5", type = "equipar" },
	["wammo|WEAPON_SMG"] = { index = "m-mp5", nome = "M.MP5", type = "recarregar" },
	["wbody|WEAPON_SMG_MK2"] = { index = "smg", nome = "SMG", type = "equipar" },
	["wammo|WEAPON_SMG_MK2"] = { index = "m-smg", nome = "M.SMG", type = "recarregar" },
	["wbody|WEAPON_ASSAULTSMG"] = { index = "mtar", nome = "Mtar", type = "equipar" },
	["wammo|WEAPON_ASSAULTSMG"] = { index = "m-mtar", nome = "M.Mtar", type = "recarregar" },
	...
	["wbody|WEAPON_SAWNOFFSHOTGUN"] = { index = "sawnoffshotgun", nome = "Shotgun Sawnoff", type = "equipar" },
	["wammo|WEAPON_SAWNOFFSHOTGUN"] = { index = "m-sawnoffshotgun", nome = "M.Shotgun Sawnoff", type = "recarregar" },
	---------------------------------------------------------------------------------------------------
	--[ FUZIL ]----------------------------------------------------------------------------------------
	---------------------------------------------------------------------------------------------------
	["wbody|WEAPON_ASSAULTRIFLE_MK2"] = { index = "ak47", nome = "AK-47", type = "equipar" },
	["wammo|WEAPON_ASSAULTRIFLE_MK2"] = { index = "m-ak47", nome = "M.AK47", type = "recarregar" },
	...
	["wbody|WEAPON_CARBINERIFLE_MK2"] = { index = "carabinemk2", nome = "Carabina MK2", type = "equipar" },
	["wammo|WEAPON_CARBINERIFLE_MK2"] = { index = "m-carabinemk2", nome = "M.Carabina MK2", type = "recarregar" },
	["wbody|WEAPON_SPECIALCARBINE_MK2"] = { index = "g36c", nome = "G36 C", type = "equipar" },
	["wammo|WEAPON_SPECIALCARBINE_MK2"] = { index = "m-g36c", nome = "M.G36 C", type = "recarregar" }
}
...
function vRP.giveInventoryItem(user_id,idname,amount)
    ...
    if data and amount > 0 then
        ...
        TriggerClientEvent("itensNotify",user_id,"sucesso","Sucesso",""..amount.." "..idname.."",idname)
    end
end
...
function vRP.tryGetInventoryItem(user_id,idname,amount)
    ...
    if data and amount > 0 then
        ...
        if entry and entry.amount >= amount then
            ...
            TriggerClientEvent("itensNotify",user_id,"negado","Negado",""..amount.." "..idname.."",idname)
            return true
        end
    end
    return false
...
-----------------------------------------------------------------------------------------------------------------------------------------
local vehglobal = {
	["blista"] = { ['name'] = "Blista", ['price'] = 120000, ['tipo'] = "carros" },
	["brioso"] = { ['name'] = "Brioso", ['price'] = 70000, ['tipo'] = "carros" },
	["emperor"] = { ['name'] = "Emperor", ['price'] = 100000, ['tipo'] = "carros" },
	["emperor2"] = { ['name'] = "Emperor 2", ['price'] = 100000, ['tipo'] = "carros" },
	["dilettante"] = { ['name'] = "Dilettante", ['price'] = 120000, ['tipo'] = "carros" },
	["issi2"] = { ['name'] = "Issi2", ['price'] = 180000, ['tipo'] = "carros" },
	["panto"] = { ['name'] = "Panto", ['price'] = 10000, ['tipo'] = "carros" },
	["prairie"] = { ['name'] = "Prairie", ['price'] = 100000, ['tipo'] = "carros" },
	["rhapsody"] = { ['name'] = "Rhapsody", ['price'] = 14000, ['tipo'] = "carros" },
	["cogcabrio"] = { ['name'] = "Cogcabrio", ['price'] = 260000, ['tipo'] = "carros" },
	["exemplar"] = { ['name'] = "Exemplar", ['price'] = 160000, ['tipo'] = "carros" },
	["f620"] = { ['name'] = "F620", ['price'] = 110000, ['tipo'] = "carros" },
	["felon"] = { ['name'] = "Felon", ['price'] = 140000, ['tipo'] = "carros" },
	["ingot"] = { ['name'] = "Ingot", ['price'] = 320000, ['tipo'] = "carros" },
	["jackal"] = { ['name'] = "Jackal", ['price'] = 120000, ['tipo'] = "carros" },
	["oracle"] = { ['name'] = "Oracle", ['price'] = 120000, ['tipo'] = "carros" },
	["oracle2"] = { ['name'] = "Oracle2", ['price'] = 120000, ['tipo'] = "carros" },
	["sentinel"] = { ['name'] = "Sentinel", ['price'] = 100000, ['tipo'] = "carros" },
	["sentinel2"] = { ['name'] = "Sentinel2", ['price'] = 60000, ['tipo'] = "carros" },
	["windsor"] = { ['name'] = "Windsor", ['price'] = 300000, ['tipo'] = "carros" },
	["windsor2"] = { ['name'] = "Windsor2", ['price'] = 300000, ['tipo'] = "carros" },
	["zion"] = { ['name'] = "Zion", ['price'] = 100000, ['tipo'] = "carros" },
	["zion2"] = { ['name'] = "Zion2", ['price'] = 120000, ['tipo'] = "carros" },
	["blade"] = { ['name'] = "Blade", ['price'] = 220000, ['tipo'] = "carros" },
	["buccaneer"] = { ['name'] = "Buccaneer", ['price'] = 260000, ['tipo'] = "carros" },
	["buccaneer2"] = { ['name'] = "Buccaneer2", ['price'] = 420000, ['tipo'] = "carros" },
	["primo"] = { ['name'] = "Primo", ['price'] = 260000, ['tipo'] = "carros" },
	["chino"] = { ['name'] = "Chino", ['price'] = 260000, ['tipo'] = "carros" },
	["coquette3"] = { ['name'] = "Coquette3", ['price'] = 205000, ['tipo'] = "carros" },
	["dukes"] = { ['name'] = "Dukes", ['price'] = 300000, ['tipo'] = "carros" },
	["faction"] = { ['name'] = "Faction", ['price'] = 300000, ['tipo'] = "carros" },
	["faction3"] = { ['name'] = "Faction3", ['price'] = 700000, ['tipo'] = "carros" },
	["gauntlet"] = { ['name'] = "Gauntlet", ['price'] = 325000, ['tipo'] = "carros" },
	["gauntlet2"] = { ['name'] = "Gauntlet2", ['price'] = 325000, ['tipo'] = "carros" },
	["hermes"] = { ['name'] = "Hermes", ['price'] = 500000, ['tipo'] = "carros" },
	["hotknife"] = { ['name'] = "Hotknife", ['price'] = 320000, ['tipo'] = "carros" },
	["moonbeam"] = { ['name'] = "Moonbeam", ['price'] = 440000, ['tipo'] = "carros" },
	["moonbeam2"] = { ['name'] = "Moonbeam2", ['price'] = 500000, ['tipo'] = "carros" },
	["nightshade"] = { ['name'] = "Nightshade", ['price'] = 400000, ['tipo'] = "carros" },
	["picador"] = { ['name'] = "Picador", ['price'] = 300000, ['tipo'] = "carros" },
	["ruiner"] = { ['name'] = "Ruiner", ['price'] = 300000, ['tipo'] = "carros" },
	["sabregt"] = { ['name'] = "Sabregt", ['price'] = 500000, ['tipo'] = "carros" },
	["sabregt2"] = { ['name'] = "Sabregt2", ['price'] = 400000, ['tipo'] = "carros" },
	["slamvan"] = { ['name'] = "Slamvan", ['price'] = 320000, ['tipo'] = "carros" },
	["slamvan3"] = { ['name'] = "Slamvan3", ['price'] = 500000, ['tipo'] = "carros" },
	["stalion"] = { ['name'] = "Stalion", ['price'] = 300000, ['tipo'] = "carros" },
	["stalion2"] = { ['name'] = "Stalion2", ['price'] = 300000, ['tipo'] = "carros" },
	["tampa"] = { ['name'] = "Tampa", ['price'] = 300000, ['tipo'] = "carros" },
	["vigero"] = { ['name'] = "Vigero", ['price'] = 300000, ['tipo'] = "carros" },
	["virgo"] = { ['name'] = "Virgo", ['price'] = 320000, ['tipo'] = "carros" },
	["virgo2"] = { ['name'] = "Virgo2", ['price'] = 500000, ['tipo'] = "carros" },
	["virgo3"] = { ['name'] = "Virgo3", ['price'] = 320000, ['tipo'] = "carros" },
	["voodoo"] = { ['name'] = "Voodoo", ['price'] = 440000, ['tipo'] = "carros" },
	["voodoo2"] = { ['name'] = "Voodoo2", ['price'] = 440000, ['tipo'] = "carros" },
	["yosemite"] = { ['name'] = "Yosemite", ['price'] = 600000, ['tipo'] = "carros" },
	["bfinjection"] = { ['name'] = "Bfinjection", ['price'] = 120000, ['tipo'] = "carros" },
	...
	["baller6"] = { ['name'] = "Baller6", ['price'] = 1000000, ['tipo'] = "carros" },
	...
	["t20"] = { ['name'] = "T20", ['price'] = 1000000, ['tipo'] = "carros" },
	...
	["brickade"] = { ['name'] = "Burrito4", ['price'] = 2260000, ['tipo'] = "carros" },
	...
	["akuma"] = { ['name'] = "Akuma", ['price'] = 850000, ['tipo'] = "motos" },
	["avarus"] = { ['name'] = "Avarus", ['price'] = 840000, ['tipo'] = "motos" },
	["bagger"] = { ['name'] = "Bagger", ['price'] = 600000, ['tipo'] = "motos" },
	["bati"] = { ['name'] = "Bati", ['price'] = 350000, ['tipo'] = "motos" },
	["bati2"] = { ['name'] = "Bati2", ['price'] = 350000, ['tipo'] = "motos" },
	["bf400"] = { ['name'] = "Bf400", ['price'] = 240000, ['tipo'] = "motos" },
	["carbonrs"] = { ['name'] = "Carbonrs", ['price'] = 670000, ['tipo'] = "motos" },
	["chimera"] = { ['name'] = "Chimera", ['price'] = 645000, ['tipo'] = "motos" },
	["cliffhanger"] = { ['name'] = "Cliffhanger", ['price'] = 610000, ['tipo'] = "motos" },
	["daemon2"]  = { ['name'] = "Daemon2", ['price'] = 440000, ['tipo'] = "motos" },
	["defiler"] = { ['name'] = "Defiler", ['price'] = 860000, ['tipo'] = "motos" },
	["diablous"] = { ['name'] = "Diablous", ['price'] = 830000, ['tipo'] = "motos" },
	["diablous2"] = { ['name'] = "Diablous2", ['price'] = 860000, ['tipo'] = "motos" },
	["double"] = { ['name'] = "Double", ['price'] = 670000, ['tipo'] = "motos" },
	["enduro"] = { ['name'] = "Enduro", ['price'] = 295000, ['tipo'] = "motos" },
	["esskey"] = { ['name'] = "Esskey", ['price'] = 620000, ['tipo'] = "motos" },
	["faggio"] = { ['name'] = "Faggio", ['price'] = 8000, ['tipo'] = "motos" },
	["faggio2"] = { ['name'] = "Faggio2", ['price'] = 10000, ['tipo'] = "motos" },
	["faggio3"] = { ['name'] = "Faggio3", ['price'] = 10000, ['tipo'] = "motos" },
	["fcr"] = { ['name'] = "Fcr", ['price'] = 240000, ['tipo'] = "motos" },
	["fcr2"] = { ['name'] = "Fcr2", ['price'] = 240000, ['tipo'] = "motos" },
	["gargoyle"] = { ['name'] = "Gargoyle", ['price'] = 645000, ['tipo'] = "motos" },
	["hakuchou"] = { ['name'] = "Hakuchou", ['price'] = 680000, ['tipo'] = "motos" },
	["hakuchou2"] = { ['name'] = "Hakuchou2", ['price'] = 1050000, ['tipo'] = "motos" },
	["hexer"] = { ['name'] = "Hexer", ['price'] = 500000, ['tipo'] = "motos" },
	["innovation"] = { ['name'] = "Innovation", ['price'] = 500000, ['tipo'] = "motos" },
	["lectro"] = { ['name'] = "Lectro", ['price'] = 680000, ['tipo'] = "motos" },
	["manchez"] = { ['name'] = "Manchez", ['price'] = 655000, ['tipo'] = "motos" },
	["nemesis"] = { ['name'] = "Nemesis", ['price'] = 645000, ['tipo'] = "motos" },
	["nightblade"] = { ['name'] = "Nightblade", ['price'] = 815000, ['tipo'] = "motos" },
	["pcj"] = { ['name'] = "Pcj", ['price'] = 20000, ['tipo'] = "motos" },
	["ruffian"] = { ['name'] = "Ruffian", ['price'] = 500000, ['tipo'] = "motos" },
	["sanchez"] = { ['name'] = "Sanchez", ['price'] = 500000, ['tipo'] = "motos" },
	["sanchez2"] = { ['name'] = "Sanchez2", ['price'] = 500000, ['tipo'] = "motos" },
	["sovereign"] = { ['name'] = "Sovereign", ['price'] = 800000, ['tipo'] = "motos" },
	["thrust"] = { ['name'] = "Thrust", ['price'] = 675000, ['tipo'] = "motos" },
	["vader"] = { ['name'] = "Vader", ['price'] = 645000, ['tipo'] = "motos" },
	["vindicator"] = { ['name'] = "Vindicator", ['price'] = 640000, ['tipo'] = "motos" },
	["vortex"] = { ['name'] = "Vortex", ['price'] = 240000, ['tipo'] = "motos" },
	["wolfsbane"] = { ['name'] = "Wolfsbane", ['price'] = 290000, ['tipo'] = "motos" },
	["zombiea"] = { ['name'] = "Zombiea", ['price'] = 490000, ['tipo'] = "motos" },
	["zombieb"] = { ['name'] = "Zombieb", ['price'] = 600000, ['tipo'] = "motos" },
	["shotaro"] = { ['name'] = "Shotaro", ['price'] = 2000000, ['tipo'] = "motos" },
	["ratbike"] = { ['name'] = "Ratbike", ['price'] = 430000, ['tipo'] = "motos" },
	...
	["policiasilverado"] = { ['name'] = "Police Mercedes AMG", ['price'] = 1000, ['tipo'] = "work" },
	...
	["policiaamarok"] = { ['name'] = "Amarok Police", ['price'] = 1000, ['tipo'] = "work" }, 
	["policiamustanggt"] = { ['name'] = "Mustang Police", ['price'] = 1000, ['tipo'] = "work" }, 
	...
	["z1000"] = { ['name'] = "Kawazaki Ninja H2R", ['price'] = 1000000, ['tipo'] = "exclusive" },
	["xt700"] = { ['name'] = "Yamaha XT700", ['price'] = 1000000, ['tipo'] = "exclusive" },
	["r6"] = { ['name'] = "Ducati DM1200", ['price'] = 1000000, ['tipo'] = "exclusive" },
	...
	["foxsupra"] = { ['name'] = "VW Golf GTI", ['price'] = 1000000, ['tipo'] = "exclusive" },		
			...
			if not chests[name] then
				...
				local cb_take = function(idname)
					...
					if amount > 0 and amount <= citem.amount then
						...
						TriggerClientEvent("Notify",source,"negado","Negado","Valor inválido.")
					end
				end
				...
				local cb_put = function(idname)
					...
					if new_weight <= max_weight then
						...
						TriggerClientEvent("Notify",source,"negado","Negado","Baú cheio.")
					end
				end
				...
				TriggerClientEvent("Notify",source,"importante","Importante","O baú está sendo utilizado no momento.")
			end
		end
	end
end