...
local garages = { 
	[1] = { locked = false, camera = { x = -338.46, y = -135.06, z = 41.13, heading = 24.20 }, driveout = { x = -341.19, y = -128.75, z = 38.53, heading = 337.74 }, drivein = { x = -341.19, y = -128.75, z = 38.53, heading = 337.74 }, outside = { x = -341.19, y = -128.75, z = 38.53, heading = 337.74 }, inside = { x = -341.19, y = -128.75, z = 38.53, heading = 337.74 }},
	[2] = { locked = false, camera = { x = -325.91, y = -138.8, z = 40.89, heading = 301.18 }, driveout = { x = -323.92, y = -132.15, z = 38.47, heading = 250.69 }, drivein = { x = -323.92, y = -132.15, z = 38.47, heading = 250.69 }, outside = { x = -323.92, y = -132.15, z = 38.47, heading = 250.69 }, inside = { x = -323.92, y = -132.15, z = 38.47, heading = 250.69 }},
	[3] = { locked = false, camera = { x = -325.3, y = -147.77, z = 39.06, heading = 35.31, heading = 301.18 }, driveout = { x = -327.25, y = -144.81, z = 38.89, heading = 69.59 }, drivein = { x = -327.25, y = -144.81, z = 38.89, heading = 69.59 }, outside = { x = -327.25, y = -144.81, z = 38.89, heading = 69.59 }, inside = { x = -327.25, y = -144.81, z = 38.89, heading = 69.59 }},
	...
	[6] = { locked = false, camera = { x = -233.54, y = 6251.84, z = 31.49, heading = 271.31 }, driveout = { x = -220.43, y = 6252.94, z = 31.01, heading = 223.32 }, drivein = {x = -220.43, y = 6252.94, z = 31.01, heading = 223.32  }, outside = { x = -220.43, y = 6252.94, z = 31.01, heading = 223.32  }, inside = {x = -220.43, y = 6252.94, z = 31.01, heading = 223.32  }},
	[7] = { locked = false, camera = { x = -230.67, y = 6256.82, z = 31.49, heading = 14.08 }, driveout = { x = -233.6, y = 6263.99, z = 31.22, heading = 313.93 }, drivein = { x = -233.6, y = 6263.99, z = 31.22, heading = 313.93 }, outside = { x = -233.6, y = 6263.99, z = 31.22, heading = 313.93 }, inside = { x = -233.6, y = 6263.99, z = 31.22, heading = 313.93 }},
										...
										if not LSC_Config.lock then
											if IsControlJustPressed(1,38) then
												if emP.checkPermission() then
													...
													TriggerEvent("Notify","negado","Negado","Apenas <b>Mecânicos</b> podem modificar os veículos.",8000)
												end
											else
												drawTxt("PRESSIONE  ~r~E~w~  PARA ACESSAR A ~y~MECÂNICA",4,0.5,0.93,0.50,255,255,255,180)
											end
										else
											drawTxt("~y~MECÂNICA~w~ OCUPADA NO MOMENTO",4,0.5,0.93,0.50,255,255,255,180)
										end
									else
										if IsControlJustPressed(1,38) then
											if emP.checkPermission() then
...
function CanPurchase(price,canpurchase)
	if canpurchase then
		if LSCMenu.currentmenu == "main" then
			...
			TriggerEvent("Notify","sucesso","Sucesso","Modificação aplicada.")
			--LSCMenu:showNotification("Modificação aplicada.")
		end
		return true
	else
		TriggerEvent("Notify","financeiro","Financeiro","Dinheiro insuficiente.")
